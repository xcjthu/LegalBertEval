...
from model.LongformerSentID.LongformerSentID import LongformerSentIDModel
...
class LecardPLM(nn.Module):
    def __init__(self, config, gpu_list, *args, **params):
        ...
        if "DimRedBERT" in plm_path:
            ...
            self.encoder = LongformerSentIDModel.from_pretrained(plm_path, output_hidden_states=False)#, mirror="tuna")
